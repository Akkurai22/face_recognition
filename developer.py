...
class developer:
    def __init__(self, root):
        ...
        img_top = Image.open("images/img4.jpg")   
        ...
        img1=Image.open("images/rohitSaraf.jpeg")  
        ...
        dev_label1=Label(main_frame,text="Hello I am Rohit Saraf" ,font=("times new romen",12 ,"bold"),bg="white",fg="Blue")
        ...
        img2 = Image.open("images/img5.jpg")
        img2= img2.resize((500, 500), Image.Resampling.LANCZOS)
        self.photoimg2 = ImageTk.PhotoImage(img2)

        f_lbl = Label(main_frame, image=self.photoimg2)
        f_lbl.place(x=0, y=270, width=500, height=500)
